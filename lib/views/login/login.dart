...
import 'package:shopify/views/sign_up/sign_up.dart';
import '../home/main_home_screen.dart';
import 'forget_password/forger_password.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<LoginShopCubit, LoginShopStates>(
      ...
      builder: (context, state) {
        ...
        } else if (state is LoginShopErrorState) {
          // Show error message
          showToast(
            text: state.error,
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          onPressed: () async {
                                            if (_formKey.currentState?.validate() ?? false) {
                                              final cubit = BlocProvider.of<LoginShopCubit>(context);
                                              await cubit.userLogin(
                                                email: _emailController.text,
                                                password: _passwordController.text,
                                                rememberMe: true, // You can add a remember me checkbox
                                              );
                                            }
                                          },
                                          child: const Text(
